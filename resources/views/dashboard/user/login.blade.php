...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class=" bg-gray-200 text-white">
        <div class="mt-24 max-w-md w-600 lg:max-w-none mx-auto h-400 flex shadow-lg " style="width: 500px;">
            ...
            <div class="w-full px-16 bg-white rounded-lg">
                <div class="max-w-lg mt-14 text-gray-700 ">
                    ...
                    @endif
                    <form class="mb-16" method="post" action="{{ route('user.check') }}">
                        @csrf
                        {{-- <div class="mb-4">
                        ...
                        class="hover:text-gray-400">i dont have an account!</a>
                    </form>
                </div>
            </div>
        </div>
